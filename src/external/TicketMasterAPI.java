...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "LJp4WGJo5UMGWnUp8ku4HQlOjy4YcyXT";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			// Send request to TicketMaster and get response, response code could be return directly
	...
	/*
	 * Main entry for TicketMasterAPI requests
	 */
